...
### 3.1.5 DataUtilities.getCumulativePercentages(KeyedValues)

`getCumulativePercentagesWithNoKeyedValues`: I tested an empty bracket	<>. it passed.

`getCumulativePercentagesWithOneRowKeyedValue`: This test case was also evaluated	<0, 2>. it passed.

`getCumulativePercentagesWithOneKeyedValueHavingZeroValue`: This test case covered 	<0, 0>. it passed.

`test_getCumulativePercentages_oneKeyedValue_nullValue` The test case evaluated	<0, null>. it passed.

`getCumulativePercentagesWithKeyedValuesHavingNullAndMixValues`: this test case evaluated 	<0, -4.5>, <1, 2>, <2, null>, <3, 12.5>, <4, 0>. it passed.
...
### 3.2.5 Range.GetCentralValue

`shiftRightToMaxValueAtZeroRangeAllowZeroCrossing`: Tested this test case for this method	(0.0, 0.0), Double.MAX_VALUE, true. it passed.

`shiftRightAtZeroRangeDisallowZeroCrossing`: Tested this test case 	(0.0, 0.0), 4.0, false. it passed.

`shiftLeftToMinValueAtZeroRangeAllowZeroCrossing`: This test case evaluated 	(0.0, 0.0), Double.MIN_VALUE, true. it passed.

`shiftLeftAtZeroRangeDisallowZeroCrossing`: this test case covered	(0.0, 0.0), -5.0, false. it passed.

`shiftRightNegativeRangeAllowZeroCrossingForLbAndUb`: This test case tested 	(-10.0, -5.0), 15.0, true. it passed.

`shiftRightNegativeRangeDisallowZeroCrossingForLbAndUb`: This test case evaluated	(-10.0, -5.0), 18.0, false. it passed.

`shiftLeftPostiveRangeAllowZeroCrossingForLbAndUb`: This test case covered	(5.0, 7.0), -10.0, true. it passed.

`shiftLeftPostiveRangeDisallowZeroCrossingForLbAndUb`: tested this method	(5.0, 7.0), -9.0, false. It passed.

`shiftRightNegativeLbAndPostiveUbRangeDisallowZeroCrossing`: Tested this case	(-3.0, 7.0), 6.0, false. it passed.

`shiftLeftNegativeLbAndPostiveUbRangeDisallowZeroCrossing` tested this case	(-3.0, 7.0), -8.0, false. It passed.
